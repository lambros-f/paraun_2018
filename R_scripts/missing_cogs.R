...
cogs <- read.csv('/Users/lfrantzeskakis/projects/03_jp_mildews/10_missing_cogs/combined_table_for_R.csv', sep = ' ', header = F)
...
annot <- read.csv('/Users/lfrantzeskakis/projects/03_jp_mildews/10_missing_cogs/gene_list_r.txt.atrrib.sorted',sep = '\t', header = F)
...
colnames(cogs.c.m.t) <- c('B. graminis fsp hordeii', "B. graminis fsp tritici","Botrytis cinerea","Colletotrichum graminicola","Erysiphe necator",
                          "Fusarium oxysporum","Glarea lozoyensis", "Magnaporthe oryzae","Marssonina brunnea","Neurospora crassa",
                          "Oidiodendron maius", "Parauncinula septata", "Penicillium digitatum", "Phialocephala scopiformis",
                          "Phialocephala subalpina", "Pseudogymnoascus destructans", "Pseudogymnoascus verrucosus",
                          "Rhynchosporium agropyri", "Rhynchosporium commune", "Rhynchosporium secalis","Sclerotinia borealis", "Sclerotinia sclerotiorum",
                          "Verticillium dahliae", "Zymoseptoria tritici")      
